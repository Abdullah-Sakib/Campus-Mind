              ...
              <View style={styles.cardRow}>
                ...
                <View style={{ flex: 1, marginLeft: spacing.sm }}>
                  ...
                  <Text style={styles.cardSubtitle}>
                    Updated {new Date(note.updatedAt).toLocaleDateString()} · {note.pages} pages ·{' '}
                    {note.sharedWithClassmates ? `Shared with ${note.sharedCount || 'classmates'}` : 'Private'}
                  </Text>
                </View>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  tagChipActive: { backgroundColor: colors.cardDark, borderColor: colors.cardDark },
  tagText: { ...fonts.body, fontWeight: '700', color: colors.textPrimary },
  tagTextActive: { color: colors.white },
  body: { padding: spacing.md, paddingTop: 0 },
  card: { backgroundColor: colors.cardDark, borderRadius: radius.lg, padding: spacing.md, marginBottom: spacing.md },
  ...
  cardSubtitle: { ...fonts.small, color: colors.textOnDarkSecondary, marginTop: 6 },
